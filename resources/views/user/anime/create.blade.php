                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <div id="coverPreviewWrap" class="anime-cover-upload"
                                ...
                                <img id="coverPreview" src="{{ asset('assets/img/no-cover.svg') }}"
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" class="form-select" required>
                                        ...
                                        <option value="{{ $k }}" {{ (old('status','plan_to_watch')===$k)?'selected':'' }}>{{ $v }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="notes" class="form-control" rows="3"
                                          placeholder="Your thoughts, comments..." maxlength="1000">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
