...
<div class="toast-container position-fixed top-0 end-0 p-3">
    <div class="toast show align-items-center text-bg-success border-0">
        <div class="d-flex">
            <div class="toast-body"><i class="bi bi-check-circle-fill me-2"></i><?php echo e(session('success')); ?></div>
...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <p class="text-center mb-0" style="font-size:.875rem;color:var(--muted)">
            ...
            <a href="<?php echo e(route('register')); ?>" style="color:var(--accent);font-weight:600">Create one free</a>
        </p>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\Laravel_Camaclang\resources\views/auth/login.blade.php ENDPATH**/ ?>