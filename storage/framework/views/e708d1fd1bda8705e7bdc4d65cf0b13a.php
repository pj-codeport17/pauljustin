...
<div class="page-header">
    ...
    <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-primary btn-sm">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value"><?php echo e($totalMsgs); ?></div>
...
<div class="card">
    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            ...
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="text-muted" style="font-size:.78rem"><?php echo e($i+1); ?></td>
                <td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new Chart(document.getElementById('topChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($topUsers->pluck('name')); ?>,
            datasets: [{
                label:'Anime',
                data:<?php echo json_encode($topUsers->pluck('animes_count')); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Camaclang\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>